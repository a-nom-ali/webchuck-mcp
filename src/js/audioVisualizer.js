...
const AudioVisualizer = (function() {
    ...
    function drawWaveform(data) {
        ...
        // Draw background
        waveformCtx.fillStyle = 'rgba(30, 30, 30, 0.5)';
    ...
    function drawSpectrum(data) {
        ...
        // Draw background
        spectrumCtx.fillStyle = 'rgba(30, 30, 30, 0.5)';
    ...
    function drawLevelMeter(level) {
        ...
        // Draw background
        levelMeterCtx.fillStyle = 'rgba(30, 30, 30, 0.5)';
        ...
        let fillColor;
        if (level < 0.5) {
            fillColor = 'rgb(0, 255, 255)'; // Green for lower levels
        } else if (level < 0.8) {
            fillColor = 'rgb(255, 255, 0)'; // Yellow for medium levels
        } else {
            fillColor = 'rgb(255, 0, 255)'; // Red for high levels
        }
        
        levelMeterCtx.fillStyle = fillColor;
        levelMeterCtx.fillRect(0, height - meterHeight, width, meterHeight);
        
        // Draw level markers
        levelMeterCtx.strokeStyle = 'white';
